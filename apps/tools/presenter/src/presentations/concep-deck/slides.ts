...
export const slides: SlideEntry[] = [
  ...
  { component: Slide02, title: 'El problema', notes: 'Render tradicional ~1 semana. Renderista profesional se reserva para post-firma. En captación no podemos pedir esa espera. Pregunta: ¿podemos darle imagen el mismo día?' },
  {
    component: Slide03,
    title: 'El flujo',
    notes: 'Cuatro pasos. Tú mismo. Misma tarde. Adelanta cada paso brevemente — luego entramos al detalle.',
    controls: [
      { kind: 'variants', label: 'Foco del flujo', stateKey: 'slide03', options: ['01 · CAD', '02 · 3D', '03 · Detalle', '04 · Render'] },
    ],
  },
  ...
  {
    component: Slide05,
    title: 'Paso 2 — SketchUp',
    notes: 'Sub-estados: 0 = intro sin zoom · 1 = mismo texto + zoom al icono C · 2 = nuevo texto sobre la extensión (hace 95% del trabajo) con imagen ya zoomeada. Usa botones presenter o flecha →.',
    controls: [
      { kind: 'variants', label: 'Paso 2 · Sub-estado', stateKey: 'slide05', options: ['01 · Intro', '02 · Zoom', '03 · Detalle'] },
    ],
  },
  {
    component: Slide07,
    title: 'Librería (3 sub-estados)',
    notes: 'Flecha → 3 veces. 1) Familias. 2) Modelos por familia. 3) Variantes (color/acabado). Énfasis: 1:1, no "parecido". El bloque del CAD apunta a la variante exacta.',
    controls: [
      { kind: 'variants', label: 'Sub-paso librería', stateKey: 'slide07', options: ['01 · Familias', '02 · Modelos', '03 · Variantes'] },
    ],
  },
  ...
  {
    component: Slide17,
    title: 'Render final · 4 variantes',
    notes: 'Slider en 97% antes. Arrastra para revelar render. Flecha → cicla las 4 variantes. Mismo CAD, 4 referencias, 4 imágenes para enseñar al cliente.',
    controls: [
      { kind: 'range', label: 'Control slider · Render', stateKey: 'slide17', lowLabel: 'Antes', highLabel: 'Después' },
      { kind: 'variants', label: 'Variante', stateKey: 'slide17', options: ['Render 01', 'Render 02', 'Render 03', 'Render 04'] },
    ],
  },
